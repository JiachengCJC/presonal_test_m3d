...
def main():
    ...
    #temporary checking
    rank0_print(f"eval_strategy={training_args.evaluation_strategy}, eval_steps={training_args.eval_steps}, logging_steps={training_args.logging_steps}")
    rank0_print(f"train size={len(train_dataset)}, eval size={len(eval_dataset)}")
